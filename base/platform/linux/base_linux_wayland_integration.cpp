...
bool ResolveWayland() {
#ifdef LINK_TO_WAYLAND
	return true;
#else // LINK_TO_WAYLAND
	...
	return loaded;
#endif // LINK_TO_WAYLAND
}

} // namespace Platform
} // namespace base

#ifndef LINK_TO_WAYLAND
namespace W = base::Platform;
...
struct wl_display *wl_display_connect_to_fd(int fd) {
	Expects(W::wl_display_connect_to_fd != nullptr);
